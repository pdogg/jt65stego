      program JT65code
C Modified by pdogg - just outputs message list
...
c 1030 format('Plain text.')         
      write(*,1040) dgen
 1040 format(12i3) !Display packed symbols

c      call packmsg(msg,dgen)                  !Pack user message
c      call rs_init                            !Initialize RS encoder
...
c      sent(32:32) = 60
c      write(*,1050) sent
c 1050 format('Channel symbols, including FEC:'/(i5,20i3))
