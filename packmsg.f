...
C  Encode data into 6-bit words
 20   dat(1)=and(rshift(nc1,22),63)                !6 bits
      dat(2)=and(rshift(nc1,16),63)                !6 bits
      dat(3)=and(rshift(nc1,10),63)                !6 bits
      dat(4)=and(rshift(nc1, 4),63)                !6 bits
      dat(5)=4*and(nc1,15)+and(rshift(nc2,26),3)   !4+2 bits
      dat(6)=and(rshift(nc2,20),63)                !6 bits
      dat(7)=and(rshift(nc2,14),63)                !6 bits
      dat(8)=and(rshift(nc2, 8),63)                !6 bits
      dat(9)=and(rshift(nc2, 2),63)                !6 bits
      dat(10)=16*and(nc2,3)+and(rshift(ng,12),15)  !2+4 bits
      dat(11)=and(rshift(ng,6),63)
      dat(12)=and(ng,63)
